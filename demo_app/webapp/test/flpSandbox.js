					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fi Documents Display",
									"targetURL": "#demoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoapp-display": {
								"semanticObject": "demoapp",
								"action": "display",
								"description": "Fi Documents Display",
								"title": "Fi Documents Display",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoapp",
									"url": sap.ui.require.toUrl("demoapp")
								}
							}
						}
					}
